...
- [ ] Supports following operations (functions defined for each):
  - [ ] addition
  - [ ] subtraction
  - [ ] multiplication
  - [ ] division
- [ ] Operate function takes an operator and 2 numbers, calling the required operator functions and 
returns a result
- [ ] Buttons for each digit and operator (including `=`)
- [ ] Display for currently inputted numbers and calculator (currently filled)
- [ ] Clear button.
...
- [ ] add CE/backspace button, to delete a number or sign
